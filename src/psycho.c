...
char *psycho_message[] =
{
    ...
    "#YYou #0wouldn't do that if #GNixon#0 was in the #WWhite House#n",
    "#RI AM #BTHE #GWALRUS#W!!!!!!{x",
  ...
  for ( d = descriptor_list; d != NULL; d = d->next )
    {
      ...
      chance1 = number_range(1, 5);  /* Increase 25 for messages to  */
      chance2 = number_range(1, 5);  /* appear less often. Both 25's */
      if(chance1 == chance2)
        {
